...
def generate_date_range(start_date= None, end_date= None, is_daily: bool = None):
    ...
    """
    log = logging.getLogger("Generating date range...")
    ...
    if start_date is not None and end_date is not None and is_daily is False:
        ...
        log.info("Setting dates for daily run...")
        ...
        log.info("Setting dates for true-up run...")
    ...
    log.info(f"Generated dates: start_date={start_date} end_date={end_date}")
